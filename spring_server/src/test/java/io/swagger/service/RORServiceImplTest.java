...
public class RORServiceImplTest {
    ...
    public void getRORByCode() {
        ...
        List<ROR> rorList = rorServImpl.getRORByCode(drugCode, outcomeCode);
        assertTrue(rorList.size() > 0);
        ROR ror = rorList.get(0);
    ...
    public void getRORByName() {
        ...
        List<ROR> rorList = rorServImpl.getRORByName(drugName, outcomeName);
        assertTrue(rorList.size() > 0);
        ROR ror = rorList.get(0);
    ...
    public void getRORByDateCode() {
        ...
        List<ROR> rorList = rorServImpl.getRORByDateCode(drugCode, outcomeCode, startDate, endDate);
        assertTrue(rorList.size() > 0);
        ROR ror = rorList.get(0);
        assertSame(ror.id, rorCode.id);
    ...
    public void getRORByDateName() {
        ...
        List<ROR> rorList = rorServImpl.getRORByDateName(drugName, outcomeName, startDate, endDate);
        assertTrue(rorList.size() > 0);
        ROR ror = rorList.get(0);
        assertSame(ror.id, rorName.id);
