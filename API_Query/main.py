...
def connect():
   ...
   # execute a statement
	...
	col_names =  ['DRUG', 'OUTCOME', 'PRR', 'ROR']
	df  = pd.DataFrame(columns = col_names)

	param = {1151789:35809005, 1119119:35809005, 1547504:35205189}
	...
	for key, value in param.items():
		...
		for date in dates:
			...
			for r in result:
				prr = r[0] 
				ror = r[1]  
				row = [drug, outcome, prr, ror]
				df.loc[len(df)] = row
	df.to_csv("/home/cynthiak/drug_outcome_date_analysis_1.csv", index=False)
