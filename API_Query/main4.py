	...
	for key, value in param.items():
		...
		for date in dates:
			...
			for r in result:
				...
				df.loc[len(df)] = row
	df.to_csv("/home/cynthiak/drug_outcome_date_analysis_4.csv", index=False)
